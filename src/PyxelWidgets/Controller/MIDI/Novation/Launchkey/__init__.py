...
class LaunchkeyMK2(Launchkey):
    ...
    def connect(self):
        super().connect()
        self.setMode(LaunchkeyMK2.mode.Extended)
        self.enableInControl(LaunchkeyMK2.inControl.pads)

    def disconnect(self):
        self.disableInControl(LaunchkeyMK2.inControl.pads)
        self.setMode(LaunchkeyMK2.mode.Basic)
        super().disconnect()
